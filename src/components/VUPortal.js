...
import VULogoutbar from './VULogoutbar'



class VUPortal extends Component {
  constructor(props)
  {
    super(props)
    this.state = {
  ...
  async loadBlockchainData()
  {
    ...
    if(networkData)
    {
      ...
      const studId = localStorage.getItem("VerifiedStudId")
  ...
  handleSubmit = (e) => {
    ...
    localStorage.setItem("VerifiedStudId", this.studId)
        ...
        <div className = "container-fluid">
          ...
          <main role="main" className="col-lg-12 d-flex">
              { this.state.detailsEntered
                ...
                : <VUViewStudentDetails students ={this.state.students}  studentsmarks={this.state.studentsmarks} />
              } 
          </main>
